...
for (int n = 4801; n<8257; n++){
    ...
    TF1 *total = new TF1(Form("total_%d", n),"pol5",3*noise_peak,midpoint);
    h1->Fit(total,"RLFMQ+");
...
*/
    ...
    std::vector<double> roots = {0,0,0,30};
